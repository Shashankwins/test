...
// {
//   if(arr[i].company.location.country=="USA" && arr[i].age >= 20 && arr[i].age <= 40 && arr[i].gender=="male")
//   {
//       b.USA.male.push(arr[i])
//   }
//   else if(arr[i].company.location.country=="USA" && arr[i].age >= 20 && arr[i].age <= 40 && arr[i].gender=="female")
//   {
//       b["USA"]["female"].push(arr[i])
//   }
//   else
//   {
//     continue;
//   }
// }
// console.table(b.USA.female , b.USA.male);
